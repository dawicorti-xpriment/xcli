...
describe('Config', function () {
  ...
  it('can be serialized with #toObj', function(done) {
    assert.deepEqual(_config.toObj(), _obj);
    done();
  });

  it('can be created with file path', function(done) {
    assert.deepEqual(
      _config.toObj(),
  ...
  it('does not modifies the hash used for initialization', function(done) {
  ...
  it('parses the frameworks and the libraries', function(done) {
  ...
  it('can be serialized with toString', function(done) {
    assert.equal(_config.toString(), 'OTHER_LDFLAGS = -framework "Foundation"');
    done();
  });

  it('sorts the internal data by setting name when serializing with toString', function(done) {
  ...
  it('appends a value for the same key when merging', function(done) {
  ...
  it('appends the extension to the included files if needed', function(done) {
  ...
  it('contains file path refs to all included xcconfigs', function(done) {
  ...
  it('can be created from multiline file', function(done) {
  ...
  it('can be created from file with comments inside', function(done) {
    var config = new Config(_fixturePath + '/with-comments.xcconfig');
    assert.deepEqual(config.toObj(), {'Key': 'Value'});
    done();
  });

  it('doesn\'t duplicate other attribute values', function(done) {
  ...
  it('preserves OTHER_LDFLAGS not related to libraries and frameworks', function(done) {
  ...
  it('merges frameworks and libraries from another Config instance', function(done) {
    var obj = {'OTHER_LDFLAGS': '-framework Foundation -weak_framework Twitter -lxml2.2.7.3'};
